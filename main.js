...
let fetchApi = async () => {
    console.log(boxen(figlet.textSync('GitHub Finder', { horizontalLayout: 'full' }), { padding: 1, margin: 1, borderStyle: 'double' }));
    ...
    const api = `https://api.github.com/users/${user_input.username}`;
